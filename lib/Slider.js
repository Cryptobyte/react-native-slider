...
_handleStartShouldSetPanResponder=function(e){return(
...
if(_this.props.disableBack&&gestureState.dx<-1){
return;
}
...
_this.props.minimumValue+
Math.round(
ratio*(_this.props.maximumValue-_this.props.minimumValue)/_this.props.step)*
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:567}}));
